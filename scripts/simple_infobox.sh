#We want to display a simple Information Box for our end users prior to executing a command. Accept one command line parameter when executing the script.
...
# yum install diaglog -y to run scripts below.
# commands to run /simple_infobox.sh shutdown and /simple_infobox.sh start

#!/bin/bash
# demo of a simple info box with diaglog and ncurses
